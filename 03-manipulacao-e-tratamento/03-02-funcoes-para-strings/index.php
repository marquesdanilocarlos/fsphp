...
echo "<p>", str_replace(['AC/DC', 'incrível', 'último'], 'Nirvana', $mbReplace), "</p>";
echo "<p>", str_replace(['AC/DC', 'incrível', ], ['Nirvana', 'demais'], $mbReplace), "</p>";
...
$endPoint = "name=Danilo&email=marquesdanilocarlos@gmail.com";
mb_parse_str($endPoint, $parseEndPoint);

var_dump($endPoint, $parseEndPoint, (object)$parseEndPoint);
