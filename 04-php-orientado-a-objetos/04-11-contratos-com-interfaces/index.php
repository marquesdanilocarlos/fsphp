...
$user = new \Source\Contracts\User("Danilo", "Marques", "marquesdanilocarlos@gmail.com");
$admin = new \Source\Contracts\UserAdmin("Robson", "Leite", "robson@gmail.com", 10);
...
var_dump($login->login($user), $login->login($admin), $login->login($user)->getFirstName(), $login->login($admin)->getFirstName());
